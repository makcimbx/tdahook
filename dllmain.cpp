...
void setupFunctions() {
	...
	winmm.ommDrvInstall = GetProcAddress(winmm.dll, "mmDrvInstal");
	...
	winmm.ommTaskSignal = GetProcAddress(winmm.dll, "mmTaskSigna");
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved) 
{
	...
	case DLL_PROCESS_ATTACH:
		...
		g_resources.LoadPackage(CUtils::GetGameDirectory(L"\\tdahook.pkg"));
